...
## Format input file
From your vcf file, create a ped/map file.

```
plink --vcf data/ngsRelate/COYEP1-4c.merged_gatk.srs_filt.subset.recode.vcf --out data/admixture/coye.subset --aec --recode
```
